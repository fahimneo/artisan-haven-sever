...
// const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.kk1ndjs.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
...
//       const craftCollection = client.db("gradientGallery").collection("crafts");
//       const extraCollection = client.db("gradientGallery").collection("extra");
